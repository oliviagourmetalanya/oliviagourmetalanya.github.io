/* ============================================
   MENÜ — Yönetim Paneli'nden 26.06.2026 16:06:30 tarihinde dışa aktarıldı
   ============================================ */
      ...
      "items": [
        {
          "name": "Hamburger (200g)",
          "icon": "🍔",
          "image": "images/menu/food-burgers-1-hamburger-200g.jpg",
          "price": 625,
        ...
        },
        {
          ...
          "icon": "🌶️",
          "image": "images/menu/food-burgers-3-mexican-burger-200g.jpg",
          "price": 665,
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "icon": "🥩",
          "image": "data:image/jpeg;base64,",
          "price": 1670,
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "icon": "🍖",
          "image": "images/menu/food-turkish-5-home-made-grilled-meatballs.jpg",
          "price": 995,
      ...
      "items": [
        {
          ...
          "icon": "🍝",
          "image": "images/menu/food-pasta-1-spaghetti-bolognese.jpg",
          "price": 595,
      ...
      "items": [
        {
          ...
          "icon": "🍹",
          "image": "images/menu/drinks-cocktails-1-sex-on-the-beach.jpg",
          "price": 595,
        ...
        },
        {
          "name": "Blue Hawaii",
          "icon": "🍹",
          "image": "images/menu/drinks-cocktails-3-blue-hawaii.jpg",
          "price": 625,
      ...
      "items": [
        {
          ...
          "icon": "🍷",
          "image": "images/menu/wines-redWines-1-angora.jpg",
          "glassPrice": null,
          "bottlePrice": 1650,
        ...
        },
        {
          ...
          "icon": "🍷",
          "image": "images/menu/wines-redWines-2-ancyra-cabernet-sauvignon-syrah.jpg",
          "glassPrice": null,
          "bottlePrice": 1850,
        ...
        },
        {
          ...
          "grape": "Malbec",
          "icon": "🍷",
          "image": "images/menu/wines-redWines-3-montes.jpg",
          "glassPrice": null,
          "bottlePrice": null,
        ...
        },
        {
          ...
          "icon": "🍷",
          "image": "images/menu/wines-redWines-6-conte-guicciardini-le-terre-chianti.jpg",
          "glassPrice": null,
          "bottlePrice": 2800,
      ...
      "items": [
        {
          ...
          "grape": "Sultaniye",
          "icon": "🥂",
          "image": "images/menu/wines-whiteWines-1-angora.jpg",
          "glassPrice": null,
          "bottlePrice": 1650,
      ...
      "items": [
        {
          ...
          "icon": "🌸",
          "image": "images/menu/wines-roseWines-1-angora.jpg",
          "glassPrice": null,
          "bottlePrice": 1650,
