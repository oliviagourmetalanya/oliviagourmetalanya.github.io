...
(function () {
  ...
  const SOCIAL_ICONS = {
    ...
    tripadvisor: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 7.5c-2.05-1.45-4.6-2.3-7.4-2.3H0l1.7 1.85a4.92 4.92 0 008.4 5.62A4.92 4.92 0 0019 7.5l1.7-1.85h-3.3c-2.8 0-5.35.85-7.4 2.3zM4.6 14.7a3.45 3.45 0 110-6.9 3.45 3.45 0 010 6.9zm0-1.4a2.05 2.05 0 100-4.1 2.05 2.05 0 000 4.1zm0-.95a1.1 1.1 0 110-2.2 1.1 1.1 0 010 2.2zm14.8 2.35a3.45 3.45 0 110-6.9 3.45 3.45 0 010 6.9zm0-1.4a2.05 2.05 0 100-4.1 2.05 2.05 0 000 4.1zm0-.95a1.1 1.1 0 110-2.2 1.1 1.1 0 010 2.2z"/></svg>',
