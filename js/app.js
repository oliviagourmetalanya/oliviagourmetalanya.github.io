...
(function () {
  ...
  const SOCIAL_ICONS = {
    ...
    tripadvisor: '<svg viewBox="0 0 24 24" fill="currentColor" shape-rendering="geometricPrecision"><path d="M12.006 4.295c-2.67 0-5.34.639-7.69 1.914H0l1.832 2A5.393 5.393 0 0 0 0 12.169a5.393 5.393 0 0 0 5.392 5.392 5.39 5.39 0 0 0 3.658-1.434l1.947 2.118 1.943-2.113a5.386 5.386 0 0 0 3.646 1.42 5.392 5.392 0 0 0 5.396-5.393c0-1.643-.734-3.115-1.892-4.107l1.905-2.075h-4.32c-2.35-1.278-5.02-1.917-7.69-1.917v-.011c.005 0 .005-.011.007 0zm-6.616 4.28a3.594 3.594 0 0 1 3.596 3.596 3.594 3.594 0 0 1-3.596 3.596A3.593 3.593 0 0 1 1.798 12.171 3.593 3.593 0 0 1 5.39 8.575zm13.222 0a3.593 3.593 0 0 1 3.594 3.596 3.593 3.593 0 0 1-3.594 3.596 3.593 3.593 0 0 1-3.596-3.596 3.593 3.593 0 0 1 3.596-3.596zM12 8.909a7.156 7.156 0 0 1 3.199-4.336c-1.026-.35-2.117-.53-3.199-.53-1.082 0-2.172.18-3.199.53A7.155 7.155 0 0 1 12 8.909zM5.39 10.132a2.038 2.038 0 0 0-2.036 2.036 2.038 2.038 0 0 0 2.036 2.036 2.038 2.038 0 0 0 2.036-2.036 2.037 2.037 0 0 0-2.036-2.036zm13.222 0a2.038 2.038 0 0 0-2.036 2.036 2.037 2.037 0 0 0 2.036 2.036 2.037 2.037 0 0 0 2.036-2.036 2.037 2.037 0 0 0-2.036-2.036z"/></svg>',
